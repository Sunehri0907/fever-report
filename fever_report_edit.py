...
def fever_score():
    ...
    if score <= 20:
       label["text"]="Report--You don't need to visit a doctor."
    elif  score > 20 and score <= 40: 
       label["text"]="Report--You might perhaps have to visit a doctor"
    else :
        label["text"]="Report--Strongly advise you to visit a doctor"
